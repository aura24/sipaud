                            ...
                            <thead>
                             <tr>
                                ...
                                <th style="width: 50%" colspan="6" class="text-center">Aspek Pengembangan dan Pencapaian Anak </th>
                                 <th style="width: 10%" rowspan="2" class="text-center">Aksi </th>
                                 <th style="width: 10%" rowspan="2" class="text-center">Catatan Anekdot </th>
                             </tr>
                                <tr>
                                    <td style="width: 10%">Agama dan Moral</td>
                                    <td style="width: 10%">Fisik Motorik</td>
                                    <td style="width: 10%">Kognitif</td>
                                    <td style="width: 10%">Bahasa</td>
                                    <td style="width: 10%">Sosial Emosional</td>
                                    <td style="width: 10%">Seni</td>
                                </tr>
                            </thead>
                            <tbody>
